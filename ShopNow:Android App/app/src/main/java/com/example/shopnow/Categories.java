...
public class Categories {
    ...
    Categories(Bitmap imagebitmap,String newshead,String dateofpublication,String section,String weburl){
    ...
    Categories(int imgid,String newshead,String dateofpublication,String section,String weburl){
        mImgID=imgid;
        mNewsHead=newshead;
        mDateofPublication=dateofpublication;
        mSection=section;
